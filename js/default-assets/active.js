(function($) {
  ...
  alime_window.on("load", function() {
    ...
    $("section.breadcrumb-area h2").addClass("show");
    $("section.breadcrumb-area nav").addClass("show");
  });
  ...
  alime_window.on("scroll", function() {
    ...
    // if (
    //   alime_window.scrollTop() >
    //   $("footer.footer-area .copywrite-text").offset().top - 250
    // ) {
    //   setTimeout(function() {
    //     $("footer.footer-area .copywrite-text").addClass("showme");
    //     $("footer.footer-area .footer-logo").addClass("showme");
    //     $("footer.footer-area .social-info").addClass("showme");
    //   }, 1000);
    // }
  });
